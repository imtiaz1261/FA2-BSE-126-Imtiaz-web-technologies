        ...
        <div class="row g-4 align-items-stretch">
            <div class="col-lg-7">
                <div class="task-create-hero">
                    ...
                    <h1 class="task-create-title">Create Task</h1>
                    <p class="task-create-subtitle">Add a new task to your database.</p>
                </div>
                ...
                <div class="task-form-shell">
                    <form action="{{ route('tasks.store') }}" method="POST" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}" class="form-control task-form-control @error('title') is-invalid @enderror" placeholder="Enter task title">
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" class="form-control task-form-textarea @error('description') is-invalid @enderror" placeholder="Write task details">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="task-error">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="category" id="category" value="{{ old('category') }}" class="form-control task-form-control @error('category') is-invalid @enderror" placeholder="e.g. Work, Personal, Study">
                            @error('category')
                                <div class="task-error">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mt-4 mb-2">
                            ...
                            <input type="date" name="due_date" id="due_date" value="{{ old('due_date') }}" class="form-control task-form-control @error('due_date') is-invalid @enderror">
                            @error('due_date')
                                <div class="task-error">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="task-illustration h-100">
                    <div class="task-illustration-card h-100 d-flex flex-column justify-content-between">
                        <div>
                            ...
                            <div class="task-illustration-title">Premium Task Entry</div>
                            <div class="task-illustration-text">
                                Capture task details, prioritize work, and keep deadlines visible inside a polished glassmorphism workspace.
                            </div>
                        </div>

                        <ul class="task-sample-list">
                            <li><i class="bi bi-check2-circle"></i> Save tasks with clean structured inputs</li>
                            <li><i class="bi bi-check2-circle"></i> Maintain fast entry with preserved values</li>
                            <li><i class="bi bi-check2-circle"></i> Fit perfectly on desktop and mobile</li>
                            <li><i class="bi bi-check2-circle"></i> Match the TaskMaster dark premium theme</li>
                        </ul>
                    </div>
                </div>
            </div>
