                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{ route('users.edit', $user) }}" class="btn btn-info-modern"
                                                       title="Edit" data-bs-toggle="tooltip">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-danger-modern" title="Delete"
                                                            onclick="confirmDelete({{ $user->id }}, '{{ $user->name }}')"
                                                            data-bs-toggle="tooltip">
                                                        <i class="bi bi-trash"></i>
                                                    </button>
                                                </div>
                                                <form id="deleteForm{{ $user->id }}" action="{{ route('users.destroy', ['user' => $user->id]) }}"
